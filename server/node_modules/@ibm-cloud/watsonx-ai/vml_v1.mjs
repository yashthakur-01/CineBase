...
class WatsonxAiMlVml_v1 extends WatsonxBaseService {
    ...
    static constructServiceUrl(providedUrlVariables) {
        return constructServiceUrl(WatsonxAiMlVml_v1.PARAMETERIZED_SERVICE_URL, WatsonxAiMlVml_v1.defaultUrlVariables, providedUrlVariables);
    }
    /*************************
     * Factory method
     ************************/
    ...
    createRequest(parameters, additionalParameters) {
        ...
        const callbackHandler = (additionalParameters === null || additionalParameters === void 0 ? void 0 : additionalParameters.callbacks)
            ? new WatsonxAiMlVml_v1.CallbackHandler(additionalParameters === null || additionalParameters === void 0 ? void 0 : additionalParameters.callbacks)
            : undefined;
    ...
    createDeployment(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'createDeployment');
        const parameters = {
            options: {
    ...
    listDeployments(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listDeployments');
        const parameters = {
            options: {
                url: ENDPOINTS.DEPLOYMENT.BASE,
                method: 'GET',
    ...
    getDeployment(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsGet');
        const parameters = {
            options: {
    ...
    updateDeployment(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsUpdate');
        const parameters = {
            options: {
                url: ENDPOINTS.DEPLOYMENT.BY_ID,
                method: 'PATCH',
    ...
    deleteDeployment(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsDelete');
        const parameters = {
            options: {
                url: ENDPOINTS.DEPLOYMENT.BY_ID,
                method: 'DELETE',
    ...
    deploymentGenerateText(params, callbacks) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsTextGeneration');
        const parameters = {
            options: {
    ...
    deploymentGenerateTextStream(params, callbacks) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsTextGenerationStream');
            const parameters = {
                options: {
    ...
    deploymentsTextChat(params, callbacks) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsTextChat');
        const parameters = {
            options: {
    ...
    deploymentsTextChatStream(params, callbacks) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsTextChatStream');
            const parameters = {
                options: {
    ...
    deploymentsTimeSeriesForecast(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deploymentsTimeSeriesForecast');
        const parameters = {
            options: {
    ...
    listFoundationModelSpecs(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listFoundationModelSpecs');
        const parameters = {
            options: {
    ...
    listFoundationModelTasks(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listFoundationModelTasks');
        const parameters = {
            options: {
    ...
    createPrompt(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'postPrompt');
        const parameters = {
            options: {
    ...
    listPrompts(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listPrompts');
        const parameters = {
            options: {
    ...
    updatePrompt(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'patchPrompt');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT.BY_ID,
                method: 'PATCH',
    ...
    deletePrompt(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deletePrompt');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT.BY_ID,
                method: 'DELETE',
    ...
    updatePromptLock(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'putPromptLock');
        const parameters = {
            options: {
    ...
    getPromptLock(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getPromptLock');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT.LOCK,
                method: 'GET',
    ...
    getPromptInput(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getPromptInput');
        const parameters = {
            options: {
    ...
    createPromptChatItem(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'postPromptChatItem');
        const parameters = {
            options: {
    ...
    createPromptSession(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'postPromptSession');
        const parameters = {
            options: {
    ...
    getPromptSession(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getPromptSession');
        const parameters = {
            options: {
    ...
    updatePromptSession(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'patchPromptSession');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT_SESSION.BY_ID,
                method: 'PATCH',
    ...
    deletePromptSession(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deletePromptSession');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT_SESSION.BY_ID,
                method: 'DELETE',
    ...
    createPromptSessionEntry(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'postPromptSessionEntry');
        const parameters = {
            options: {
    ...
    listPromptSessionEntries(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getPromptSessionEntries');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT_SESSION.ENTRIES,
                method: 'GET',
    ...
    createPromptSessionEntryChatItem(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'postPromptSessionEntryChatItem');
        const parameters = {
            options: {
    ...
    updatePromptSessionLock(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'putPromptSessionLock');
        const parameters = {
            options: {
    ...
    getPromptSessionLock(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getPromptSessionLock');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT_SESSION.LOCK,
                method: 'GET',
    ...
    getPromptSessionEntry(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getPromptSessionEntry');
        const parameters = {
            options: {
    ...
    deletePromptSessionEntry(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deletePromptSessionEntry');
        const parameters = {
            options: {
                url: ENDPOINTS.PROMPT_SESSION.ENTRY_BY_ID,
                method: 'DELETE',
    ...
    textChatStream(params, callbacks) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textChatStream');
            const parameters = {
                options: {
    ...
    embedText(params, callbacks) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textEmbeddings');
        const parameters = {
            options: {
    ...
    createTextExtraction(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textExtraction');
        const parameters = {
            options: {
    ...
    listTextExtractions(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listTextExtractions');
        const parameters = {
            options: {
                url: ENDPOINTS.TEXT.EXTRACTIONS,
                method: 'GET',
    ...
    getTextExtraction(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textExtractionGet');
        const parameters = {
            options: {
    ...
    deleteTextExtraction(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textExtractionDelete');
        const parameters = {
            options: {
                url: ENDPOINTS.TEXT.EXTRACTION_BY_ID,
                method: 'DELETE',
    ...
    generateText(params, callbacks) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textGeneration');
        const parameters = {
            options: {
    ...
    generateTextStream(params, callbacks) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textGenerationStream');
            const parameters = {
                options: {
    ...
    tokenizeText(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textTokenization');
        const parameters = {
            options: {
    ...
    timeSeriesForecast(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'timeSeriesForecast');
        const parameters = {
            options: {
    ...
    createTraining(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'trainingsCreate');
        const parameters = {
            options: {
    ...
    listTrainings(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'trainingsList');
        const parameters = {
            options: {
                url: ENDPOINTS.TRAINING.BASE,
                method: 'GET',
    ...
    getTraining(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'trainingsGet');
        const parameters = {
            options: {
    ...
    deleteTraining(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'trainingsDelete');
        const parameters = {
            options: {
                url: ENDPOINTS.TRAINING.BY_ID,
                method: 'DELETE',
    ...
    textRerank(params, callbacks) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'textRerank');
        const parameters = {
            options: {
    ...
    createFineTuning(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'createFineTuning');
        const parameters = {
            options: {
    ...
    listFineTunings(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'fineTuningList');
        const parameters = {
            options: {
                url: ENDPOINTS.FINE_TUNING.BASE,
                method: 'GET',
    ...
    getFineTuning(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getFineTuning');
        const parameters = {
            options: {
    ...
    deleteFineTuning(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deleteFineTuning');
        const parameters = {
            options: {
                url: ENDPOINTS.FINE_TUNING.BY_ID,
                method: 'DELETE',
    ...
    createDocumentExtraction(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'createDocumentExtraction');
        const parameters = {
            options: {
    ...
    listDocumentExtractions(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listDocumentExtractions');
        const parameters = {
            options: {
                url: ENDPOINTS.TUNING_DOCUMENT.BASE,
                method: 'GET',
    ...
    getDocumentExtraction(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getDocumentExtraction');
        const parameters = {
            options: {
    ...
    cancelDocumentExtractions(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'cancelDocumentExtractions');
        const parameters = {
            options: {
                url: ENDPOINTS.TUNING_DOCUMENT.BY_ID,
                method: 'DELETE',
    ...
    createSyntheticDataGeneration(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'createSyntheticDataGeneration');
        const parameters = {
            options: {
    ...
    listSyntheticDataGenerations(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listSyntheticDataGenerations');
        const parameters = {
            options: {
                url: ENDPOINTS.SYNTHETIC_DATA.BASE,
                method: 'GET',
    ...
    getSyntheticDataGeneration(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getSyntheticDataGeneration');
        const parameters = {
            options: {
    ...
    cancelSyntheticDataGeneration(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'cancelSyntheticDataGeneration');
        const parameters = {
            options: {
                url: ENDPOINTS.SYNTHETIC_DATA.BY_ID,
                method: 'DELETE',
    ...
    createTaxonomy(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'createTaxonomy');
        const parameters = {
            options: {
    ...
    listTaxonomies(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listTaxonomies');
        const parameters = {
            options: {
                url: ENDPOINTS.TAXONOMY.BASE,
                method: 'GET',
    ...
    getTaxonomy(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getTaxonomy');
        const parameters = {
            options: {
    ...
    deleteTaxonomy(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deleteTaxonomy');
        const parameters = {
            options: {
                url: ENDPOINTS.TAXONOMY.BY_ID,
                method: 'DELETE',
    ...
    listUtilityAgentTools(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listUtilityAgentTools');
        const parameters = {
            options: {
    ...
    getUtilityAgentTool(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getUtilityAgentTool');
        const parameters = {
            options: {
    ...
    runUtilityAgentTool(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'runUtilityAgentTool');
        const parameters = {
            options: {
    ...
    runUtilityAgentToolByName(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'runUtilityAgentToolByName');
        const parameters = {
            options: {
    ...
    transcribeAudio(params) {
        ...
        if (_params.language)
            form.append('language', _params.language);
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'transcribeAudio');
        const query = {
            'version': this.version,
        };
        const parameters = {
            ...
            defaultOptions: Object.assign(Object.assign({}, this.baseOptions), { headers: Object.assign(Object.assign(Object.assign(Object.assign({}, sdkHeaders), { 'Accept': 'application/json', 'Content-Type': 'multipart/form-data' }), form.getHeaders()), _params.headers), axiosOptions: {
                    signal: _params.signal,
                } }),
        };
        return this.createRequest(parameters);
    ...
    createTextClassification(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'createTextClassification');
        const parameters = {
            options: {
    ...
    listTextClassifications(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'listTextClassifications');
        const parameters = {
            options: {
                url: ENDPOINTS.TEXT.CLASSIFICATIONS,
                method: 'GET',
    ...
    getTextClassification(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'getTextClassification');
        const parameters = {
            options: {
    ...
    deleteTextClassification(params) {
        ...
        const sdkHeaders = getSdkHeaders(WatsonxAiMlVml_v1.DEFAULT_SERVICE_NAME, 'vml_v1', 'deleteTextClassification');
        const parameters = {
            options: {
                url: ENDPOINTS.TEXT.CLASSIFICATION_BY_ID,
                method: 'DELETE',
...
/** @hidden */
WatsonxAiMlVml_v1.PARAMETERIZED_SERVICE_URL = ML_CLOUD_BASE_URL;
/** @hidden */
...
(function (WatsonxAiMlVml_v1) {
    WatsonxAiMlVml_v1.ApiErrorTarget = Types.ApiErrorTarget;
    WatsonxAiMlVml_v1.DataConnectionReference = Types.DataConnectionReference;
    WatsonxAiMlVml_v1.DeploymentEntity = Types.DeploymentEntity;
    WatsonxAiMlVml_v1.DeploymentStatus = Types.DeploymentStatus;
    WatsonxAiMlVml_v1.DeploymentTextGenProperties = Types.DeploymentTextGenProperties;
    WatsonxAiMlVml_v1.FoundationModel = Types.FoundationModel;
    WatsonxAiMlVml_v1.HardwareRequest = Types.HardwareRequest;
    WatsonxAiMlVml_v1.JsonPatchOperation = Types.JsonPatchOperation;
    WatsonxAiMlVml_v1.LifeCycleState = Types.LifeCycleState;
    WatsonxAiMlVml_v1.ObjectLocation = Types.ObjectLocation;
    WatsonxAiMlVml_v1.PromptTuning = Types.PromptTuning;
    WatsonxAiMlVml_v1.TextChatParameterTools = Types.TextChatParameterTools;
    WatsonxAiMlVml_v1.TextChatResponseFormat = Types.TextChatResponseFormat;
    WatsonxAiMlVml_v1.TextChatResultChoice = Types.TextChatResultChoice;
    WatsonxAiMlVml_v1.TextChatResultChoiceStream = Types.TextChatResultChoiceStream;
    WatsonxAiMlVml_v1.TextChatToolCall = Types.TextChatToolCall;
    WatsonxAiMlVml_v1.TextChatToolChoiceTool = Types.TextChatToolChoiceTool;
    WatsonxAiMlVml_v1.TextChatUserImageURL = Types.TextChatUserImageURL;
    WatsonxAiMlVml_v1.TextExtractionDataReference = Types.TextExtractionDataReference;
    WatsonxAiMlVml_v1.TextExtractionResults = Types.TextExtractionResults;
    WatsonxAiMlVml_v1.TextGenParameters = Types.TextGenParameters;
    WatsonxAiMlVml_v1.TextGenResponseFieldsResultsItem = Types.TextGenResponseFieldsResultsItem;
    WatsonxAiMlVml_v1.TrainingStatus = Types.TrainingStatus;
    WatsonxAiMlVml_v1.ChatItem = Types.ChatItem;
    WatsonxAiMlVml_v1.PromptLock = Types.PromptLock;
    WatsonxAiMlVml_v1.WxPromptResponse = Types.WxPromptResponse;
    WatsonxAiMlVml_v1.WxPromptSessionEntry = Types.WxPromptSessionEntry;
    WatsonxAiMlVml_v1.TextChatMessagesTextChatMessageAssistant = Types.TextChatMessagesTextChatMessageAssistant;
    WatsonxAiMlVml_v1.TextChatMessagesTextChatMessageSystem = Types.TextChatMessagesTextChatMessageSystem;
    WatsonxAiMlVml_v1.TextChatMessagesTextChatMessageTool = Types.TextChatMessagesTextChatMessageTool;
    WatsonxAiMlVml_v1.TextChatMessagesTextChatMessageUser = Types.TextChatMessagesTextChatMessageUser;
    WatsonxAiMlVml_v1.TextChatUserContentsTextChatUserImageURLContent = Types.TextChatUserContentsTextChatUserImageURLContent;
    WatsonxAiMlVml_v1.TextChatUserContentsTextChatUserTextContent = Types.TextChatUserContentsTextChatUserTextContent;
    WatsonxAiMlVml_v1.FineTuningEntity = Types.FineTuningEntity;
    WatsonxAiMlVml_v1.FineTuningPeftParameters = Types.FineTuningPeftParameters;
    WatsonxAiMlVml_v1.DocumentExtractionStatus = Types.DocumentExtractionStatus;
    WatsonxAiMlVml_v1.SyntheticDataGenerationDataReference = Types.SyntheticDataGenerationDataReference;
    WatsonxAiMlVml_v1.SyntheticDataGenerationStatus = Types.SyntheticDataGenerationStatus;
    WatsonxAiMlVml_v1.TaxonomyStatus = Types.TaxonomyStatus;
    WatsonxAiMlVml_v1.ModelResourceEntity = Types.ModelResourceEntity;
    WatsonxAiMlVml_v1.ContentLocation = Types.ContentLocation;
    WatsonxAiMlVml_v1.DocumentExtractionObjectLocation = Types.DocumentExtractionObjectLocation;
    WatsonxAiMlVml_v1.ObjectLocationGithub = Types.ObjectLocationGithub;
    WatsonxAiMlVml_v1.TextClassificationDataReference = Types.TextClassificationDataReference;
    WatsonxAiMlVml_v1.TextClassificationParameters = Types.TextClassificationParameters;
    WatsonxAiMlVml_v1.TextClassificationResults = Types.TextClassificationResults;
    WatsonxAiMlVml_v1.TextClassificationSemanticConfig = Types.TextClassificationSemanticConfig;
    WatsonxAiMlVml_v1.PostPromptConstants = Types.PostPromptConstants;
    WatsonxAiMlVml_v1.PatchPromptConstants = Types.PatchPromptConstants;
    WatsonxAiMlVml_v1.PutPromptLockConstants = Types.PutPromptLockConstants;
    WatsonxAiMlVml_v1.PostPromptSessionEntryConstants = Types.PostPromptSessionEntryConstants;
    WatsonxAiMlVml_v1.PutPromptSessionLockConstants = Types.PutPromptSessionLockConstants;
    WatsonxAiMlVml_v1.TextChatConstants = Types.TextChatConstants;
    WatsonxAiMlVml_v1.TextChatStreamConstants = Types.TextChatStreamConstants;
    WatsonxAiMlVml_v1.TrainingsListConstants = Types.TrainingsListConstants;
    WatsonxAiMlVml_v1.CreateFineTuningConstants = Types.CreateFineTuningConstants;
    ...
    class TextClassificationsPager {
        ...
        getNext() {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { result } = response;
                const next = ((_a = result === null || result === void 0 ? void 0 : result.next) === null || _a === void 0 ? void 0 : _a.href) ? getQueryParam(result.next.href, 'start') : null;
                this.pageContext.next = next;
                if (!next) {
                    this._hasNext = false;
                }
    ...
    WatsonxAiMlVml_v1.TextClassificationsPager = TextClassificationsPager;
    /**
...
export { PostPromptConstants, PatchPromptConstants, PutPromptLockConstants, PostPromptSessionEntryConstants, PutPromptSessionLockConstants, TextChatConstants, TextChatStreamConstants, TrainingsListConstants, CreateFineTuningConstants, ApiErrorTarget, DataConnectionReference, DeploymentEntity, DeploymentStatus, DeploymentTextGenProperties, FoundationModel, HardwareRequest, JsonPatchOperation, LifeCycleState, ObjectLocation, PromptTuning, TextChatParameterTools, TextChatResponseFormat, TextChatResultChoice, TextChatResultChoiceStream, TextChatToolChoiceTool, TextExtractionDataReference, TextExtractionResults, TextGenParameters, TextGenResponseFieldsResultsItem, TrainingStatus, ChatItem, PromptLock, WxPromptResponse, WxPromptSessionEntry, TextChatMessagesTextChatMessageAssistant, TextChatMessagesTextChatMessageSystem, TextChatMessagesTextChatMessageTool, TextChatMessagesTextChatMessageUser, TextChatUserContentsTextChatUserImageURLContent, TextChatUserContentsTextChatUserTextContent, FineTuningEntity, FineTuningPeftParameters, DocumentExtractionStatus, SyntheticDataGenerationDataReference, SyntheticDataGenerationStatus, TaxonomyStatus, ModelResourceEntity, ContentLocation, DocumentExtractionObjectLocation, ObjectLocationGithub, TextClassificationDataReference, TextClassificationParameters, TextClassificationResults, TextClassificationSemanticConfig, TextChatToolCall, TextChatUserImageURL, } from "./types/index.mjs";
