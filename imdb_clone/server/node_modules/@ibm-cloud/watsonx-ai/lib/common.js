...
function getSdkHeaders(serviceName, serviceVersion, operationId) {
    ...
    const sdkVersion = version_1.VERSION;
    const osName = os_1.default.platform();
...
function transformStreamWithPipeline(apiResponse, transformStream) {
    ...
    const combinedStream = (0, stream_1.pipeline)(readableStream, transformStream, handlePipelineError);
