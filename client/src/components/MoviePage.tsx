...
function MoviePage() {
  ...
  useEffect(() => {
    const fetchMovie = async () => {
      ...
      try {
        setLoading(true);
        const res = await axios.get(`${API_BASE}/public/get-movie/${tmdb_id}`);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="text-center lg:text-left">
              ...
              {movie.tagline && (
                <p className="text-base sm:text-lg text-purple-300 italic">
                  "{movie.tagline}"
                </p>
              )}
            </div>
